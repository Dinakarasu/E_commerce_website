 ...
 */
@WebServlet("/sellerForgetPassword")
public class SellerForgetPassword extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Selleruser sellerforget = repo.selleruserForgetpassword(email);
		if(sellerforget!=null) {
		if(email!=null || !email.equals("")) {
			...
			try {
				...
				message.setSubject("Seller Reset password");
			...
			response.sendRedirect("sellerforgetpassword.jsp");
