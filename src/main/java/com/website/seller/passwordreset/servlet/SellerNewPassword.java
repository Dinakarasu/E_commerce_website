 ...
 */
@WebServlet("/sellernewPassword")
public class SellerNewPassword extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (newPassword != null && confPassword != null && newPassword.equals(confPassword)) {
			...
			try(PrintWriter out=response.getWriter()) {
				...
				PreparedStatement pst = con.prepareStatement("update sellerusers set password = ? where email = ? ");
			...
			response.sendRedirect("sellerreset.jsp");
